  ...
  translations: {
    ...
    common: {
      ...
      'zh-TW': {
        ...
        footer_copyright: '© 2026 SnapToolbox. All rights reserved. 所有處理均在您的瀏覽器中完成。',
    ...
    unit_converter: {
      ...
      'zh-TW': {
        ...
        cat_data: '資料',
        cat_time: '時間',
        privacy_note: '所有計算都在瀏覽器中完成。',
        mascot_bubble: '單位轉換交給我！慢慢等就好！',
      }
    },
