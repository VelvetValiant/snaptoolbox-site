  ...
  translations: {
    ...
    index: {
      en: {
        ...
        about_subtitle: 'Unlike typical online tools, SnapToolbox is designed to put you in control.',
        diff_1_title: 'Your Data Never Leaves',
        diff_1_desc: 'Other tools upload your files to their servers. SnapToolbox processes everything in your browser — your images, text, and data stay 100% on your device.',
        diff_1_vs: 'Others: upload to server',
        diff_2_title: 'Truly Unlimited & Free',
        diff_2_desc: 'No "20 files per session" limit, no 5MB cap, no hidden paywalls. Use every tool as many times as you want, with no file size restrictions.',
        diff_2_vs: 'Others: limited free tier',
        diff_3_title: 'You Control the Quality',
        diff_3_desc: 'Adjust compression with a quality slider and choose your output format. Other tools decide for you — we let you find the perfect balance.',
        diff_3_vs: 'Others: no quality control',
        diff_4_title: 'All-in-One Toolbox',
        diff_4_desc: 'Image compression, JSON formatting, text counting, unit conversion, and color picking — all in one place. No more juggling between different sites.',
        diff_4_vs: 'Others: single-purpose only',
        diff_5_title: 'Multilingual Support',
        diff_5_desc: 'Switch between English and Japanese with one click. We\'re expanding to more languages — so everyone can use powerful tools in their own language.',
        diff_5_vs: 'Others: English only',
        badge_no_upload: 'No Server Upload',
        badge_unlimited: 'Unlimited & Free',
        badge_quality: 'Quality Control',
      ...
      ja: {
        ...
        about_subtitle: '他のオンラインツールとは違う、あなたが主役の設計です。',
        diff_1_title: 'あなたのデータは外に出ない',
        diff_1_desc: '他のツールはファイルをサーバーにアップロードします。SnapToolboxはすべてブラウザ内で処理。画像もテキストもデータも、100%あなたの端末に留まります。',
        diff_1_vs: '他社：サーバーにアップロード',
        diff_2_title: '本当に無制限＆無料',
        diff_2_desc: '「1回20枚まで」の制限も、5MBの上限も、隠れた課金もありません。すべてのツールを何度でも、ファイルサイズ制限なしで使えます。',
        diff_2_vs: '他社：無料枠に制限あり',
        diff_3_title: '品質はあなたがコントロール',
        diff_3_desc: '品質スライダーで圧縮率を調整し、出力フォーマットも選べます。他のツールはアルゴリズム任せ — SnapToolboxはあなたに最適なバランスを委ねます。',
        diff_3_vs: '他社：品質調整なし',
        diff_4_title: 'オールインワン・ツールボックス',
        diff_4_desc: '画像圧縮、JSON整形、文字数カウント、単位変換、カラー変換 — すべてが一つの場所に。もう複数のサイトを行き来する必要はありません。',
        diff_4_vs: '他社：単機能のみ',
        diff_5_title: '多言語対応',
        diff_5_desc: 'ワンクリックで英語と日本語を切り替え。対応言語はさらに拡大予定 — 誰もが自分の言語でパワフルなツールを使える世界を目指しています。',
        diff_5_vs: '他社：英語のみ',
        badge_no_upload: 'サーバー送信なし',
        badge_unlimited: '無制限＆無料',
        badge_quality: '品質コントロール',
