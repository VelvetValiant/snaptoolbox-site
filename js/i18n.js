  ...
  translations: {
    ...
    common: {
      ...
      ja: {
        ...
        footer_contact_link: 'お問い合わせはこちら',
        sns_title: 'SNS MyLink',
        sns_add: 'リンクを追加',
        sns_placeholder: 'https://twitter.com/yourname',
        sns_save: '保存',
        ...
        sns_note: 'SNSアカウントを登録しておくと、どのページからでも各SNSへ簡単にアクセスできます。リンクが表示されるだけで、その他のデータは共有されません。補正した画像は一度ダウンロードしてからご利用ください。',
    ...
    about: {
      ...
      ja: {
        ...
        contact_desc: 'ご質問、フィードバック、提携に関するお問い合わせなど、お気軽にご連絡ください。',
      }
    },
